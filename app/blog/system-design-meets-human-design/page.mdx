export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.kellyphan.dev/blog/system-design-meets-human-design',
  },
  openGraph: {
    title: 'System Design Meets Human Design: Lessons from Scaling APIs and Scaling Usability',
    description: 'Exploring the fascinating parallels between scaling technical systems and scaling user experiences. How the same principles that make APIs resilient can make interfaces more usable and accessible.',
    url: 'https://www.kellyphan.dev/blog/system-design-meets-human-design',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'System Design Meets Human Design - Kelly Phan',
      },
    ],
    locale: 'en_US',
    type: 'article',
    ...
    authors: ['Kelly Phan'],
    tags: ['System Design', 'UX Design', 'API Design', 'Usability'],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'System Design Meets Human Design: Lessons from Scaling APIs and Scaling Usability',
    description: 'Exploring the fascinating parallels between scaling technical systems and scaling user experiences.',
    images: ['/assets/portfolio-preview.png'],
  },
  keywords: ['System Design', 'UX Design', 'API Design', 'Usability', 'Kelly Phan'],
};
