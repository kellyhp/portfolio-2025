export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.kellyphan.dev/blog/the-first-hurdle-user-onboarding-and-retention',
  },
  openGraph: {
    title: 'The First Hurdle: User Onboarding and Retention in Digital Platforms',
    description: 'Exploring human behavior patterns in user onboarding and how understanding user psychology can dramatically improve platform retention rates. Insights from HCI research and real-world applications.',
    url: 'https://www.kellyphan.dev/blog/the-first-hurdle-user-onboarding-and-retention',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'User Onboarding and Retention - Kelly Phan',
      },
    ],
    locale: 'en_US',
    type: 'article',
    ...
    authors: ['Kelly Phan'],
    tags: ['User Onboarding', 'Retention', 'UX Design', 'User Psychology'],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'The First Hurdle: User Onboarding and Retention in Digital Platforms',
    description: 'Exploring human behavior patterns in user onboarding and how understanding user psychology can dramatically improve platform retention rates.',
    images: ['/assets/portfolio-preview.png'],
  },
  keywords: ['User Onboarding', 'Retention', 'UX Design', 'User Psychology', 'Kelly Phan'],
};
