export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.kellyphan.dev/blog/ai-pipelines-beyond-model',
  },
  openGraph: {
    title: 'AI Pipelines Beyond the Model: Designing Workflows That Actually Scale in the Real World',
    description: 'Exploring how the real challenge in AI systems isn\'t the models themselves, but the pipelines that orchestrate them. Understanding workflow design, orchestration, and system architecture for production AI.',
    url: 'https://www.kellyphan.dev/blog/ai-pipelines-beyond-model',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'AI Pipelines Beyond the Model - Kelly Phan',
      },
    ],
    locale: 'en_US',
    type: 'article',
    ...
    authors: ['Kelly Phan'],
    tags: ['AI', 'System Design', 'Pipelines', 'Production Systems'],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'AI Pipelines Beyond the Model: Designing Workflows That Actually Scale in the Real World',
    description: 'Exploring how the real challenge in AI systems isn\'t the models themselves, but the pipelines that orchestrate them.',
    images: ['/assets/portfolio-preview.png'],
  },
  keywords: ['AI Pipelines', 'System Design', 'Production AI', 'Workflow Design', 'Kelly Phan'],
};
